    ...
    <div class="wrapper d-flex align-items-stretch">
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components mb-5">
                ...
                <li>
                    <a href="tablaegreso.blade.php"><span class="fa fa-trophy mr-3"></span> Egresos</a>
                </li>
                <li>
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p>
                        <a href="{{route('egreso.create')}}" class="btn btn-secondary">Agregar nuevo Registro </a>
                    </p>
                    <p class="card-text"></p>
                    <br>
                    ...
                    <div class="table table-responsive">
                        <table class="table table-sm table-bordered">
                            <thead>
                            <td>id_camion</td>
                            <td>id_bodega_egreso</td>
                            <td>fecha_hora_egreso</td>
                            <td>destino</td>
                            <td>carga</td>
                            <td>Editar</td>
                            <td>Eliminar</td>
                            ...
                            @foreach($egreso as $item)
                                <tr>
                                    ...
                                    <td>{{$item->id_bodega_egreso}}</td>
                                    <td>{{$item->destino}}</td>
                                    <td>{{$item->carga}}</td>
                                    <td><form action="{{route($item->id_camion)}}" method="GET">
                                            <button class="btn btn-outline-info btn-sm">
                                                <span class="fa-solid fa-pen-to-square"></span>
                                                <i class="fa-regular fa-pen-to-square"></i>
                                            </button>
                                        </form><form action="{{route($item->id_camion)}}" method="GET">
                                            <button class="btn btn-outline-info btn-sm">
