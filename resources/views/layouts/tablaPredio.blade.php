    ...
    <div class="wrapper d-flex align-items-stretch">
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components mb-5">
                ...
                <li>
                    <a href="{{route('piloto.index')}}"><span class="fa fa-cog mr-3"></span>Agregar Pilotos</a>
                </li>
                <li>
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title">Registro de Predios</h5>
                    <p>
                        <a href="{{route('predio.create')}}" class="btn btn-secondary">Agregar nuevo Registro </a>
                        <a href="{{route('piloto.index')}}" class="btn btn-secondary">Agregar Piloto</a>
                    </p>
                    <p class="card-text"></p>
                    <br>
                        ...
                        <table class="table table-sm table-bordered">
                            ...
                            @foreach($predios as $item)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('predio.edit', ['id' => $item->id]) }}" method="GET" style="display: inline;">
                                    ...
                                    <td>
                                        <form action="{{ route('predio.delete', ['id' => $item->id]) }}" method="GET" style="display: inline;">
                                            @csrf
                                            @method('DELETE')
